...
KEYWORDS: glob, proc, func, main, local, var, while, do, until,
if, else, halt, print, return,
...
ALGO ::= INSTR | INSTR ; ALGO → FIRST collisions

TERM ::= ATOM | ( UNOP TERM ) | ( TERM BINOP TERM ) → parenthesis ambiguity

INPUT ::= ε | ATOM | ATOM ATOM | ATOM ATOM ATOM → FIRST/FOLLOW overlap with ε

List-style rules (VARIABLES, PROCDEFS, FUNCDEFS) → nullable recursion conflicts

IDENT ambiguity (keyword vs variable name)
